...
cadena="select CIERRES_LOTE_SALUD.legajo, CIERRES_LOTE_SALUD.importe, CIERRES_LOTE_SALUD.vencimiento, dbo.Afiliados.nombre, dbo.Afiliados.documento, dbo.Afiliados.cuentabco from CIERRES_LOTE_SALUD inner join dbo.Afiliados ON "
cadena=cadena & " CIERRES_LOTE_SALUD.legajo = dbo.Afiliados.numeroafiliado where CIERRES_LOTE_SALUD.mes_procesado=" & request("mes") & " AND dbo.Afiliados.numeroafiliado <> '24485168' AND dbo.Afiliados.numeroafiliado <> '1' AND dbo.afiliados.tipoafiliado=8 order by CONVERT(numeric, CIERRES_LOTE_SALUD.legajo)"
            ...
            <tr>
              ...
              <table width="800" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr class="style33">
					...
					<td bgcolor="#F9F1C8" ><div align="center"><strong>&nbsp;( % )</strong></div></td>
					<%else%>
