...
SET RS2=NOTHING
	%>
                        ...
                        <tr>
						  ...
						  %>                            </td>
                          <td width="124" bgcolor="#FFFFFF"><div align="center"><a href="financiera_Hdetalle.asp?mes=<%=rs.fields(0)%>" target="_blank" class="style41 style40"><strong><span class="style41"> DETALLE</span></strong></a></div></td>
                        </tr>
